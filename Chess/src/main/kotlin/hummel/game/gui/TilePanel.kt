...
import main.kotlin.hummel.game.util.BoardUtilities.getImageOfTeamPiece
import main.kotlin.hummel.game.util.MoveUtilities.controlCheckState
import main.kotlin.hummel.game.util.MoveUtilities.isValidMove
						...
						if (isValidMove(chessBoard, destinationTile)) {
							...
							if (move.hasKilledPiece()) {
								if (move.killedPiece.type === PieceTypes.KING) {
									val winnerTeam: Team =
										if (move.killedPiece.team === Team.BLACK) Team.WHITE else Team.BLACK
